resource "aws_lambda_permission" "get_companies_lambda_permission" {
  for_each = toset([
    var.get_companies_lambda_arn,
    var.save_company_lambda_arn, 
    var.get_company_details_by_id_lambda_arn, 
    var.delete_company_by_id_lambda_arn, 
    var.push_contact_message_lambda_arn, 
    var.get_contact_messages_lambda_arn, 
    var.get_reviews_by_company_id_lambda_arn, 
    var.add_review_lambda_arn, 
